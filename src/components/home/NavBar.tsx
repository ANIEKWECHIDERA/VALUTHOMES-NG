...
const Navbar = () => {
  ...
  const listPropertyDropdownRef = useRef<HTMLDivElement>(null);
  ...
  // Animation variants for dropdown (simplified for mobile)
  ...
  // Desktop dropdown variants (unchanged, still needs height animation)
